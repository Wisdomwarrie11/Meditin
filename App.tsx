          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-slate-400 text-sm font-medium">
                ...
                <li><Link to="/privacy-policy" className="hover:text-brandOrange transition-colors">Privacy Policy</Link></li>
                <li><Link to="/terms-of-service" className="hover:text-brandOrange transition-colors">Terms of Service</Link></li>
              </ul>
            </div>
            <div>
